...
public class MyAgentContainer2 extends Application {
    ...
    public void setMyAgent(MyAgent2 myAgent) {
    ...
    private void startAgentContainer() throws ControllerException{
        ...
        profile.setParameter( ProfileImpl.CONTAINER_NAME, "My Agent Container 2");
        AgentContainer agentContainer = runtime.createAgentContainer(profile);
        AgentController agentController = agentContainer.createNewAgent("agent2", "agents.MyAgent2", new Object[]{this});
